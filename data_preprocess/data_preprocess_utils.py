...
def train_val_split(x_win_all, y_win_all, split_ratio=0.8):
    # split train into train and validation with the same ratio
    x_win_train, x_win_val, y_win_train, y_win_val = \
        train_test_split(x_win_all, y_win_all, test_size=split_ratio, random_state=0)
